...
#plot assignment
png(file = "png4.png") ## open PNG device, create plot in working directory
par(bg = "transparent")
par(mfrow = c(2,2))
## plot
with(data, {
...
plot(data$dateTime, data$Voltage, main = " ", 
     xlab="datetime", ylab = "Voltage", type = "l")  
plot(data$dateTime, data$Sub_metering_1, main = " ", 
     xlab = " ", ylab = "Energy sub metering ", type = "l", bg = "grey")
...
plot(data$dateTime, data$Global_reactive_power, main = " ", 
